---
lab:
    title: 'Train a classification model to predict diabetes'
    module: 'Get started with data science in Microsoft Fabric'
---

# Use notebooks to train a model in Microsoft Fabric

In this lab, you'll use Microsoft Fabric to create a notebook and train a machine learning model to predict diabetes. You'll use scikit-learn to train the model and MLflow to track its performance.
