...
1. Before continuing, you need to **Save** the report as a PBIP file.
1. In the Save as pane, you can choose the file type by selecting the arrow in the drop-down menu when you name the file.
...
Let's look at how changes in Power BI Desktop are reflected in the PBIP flat files.
...
In this task, we'll make changes to the report in Power BI Desktop and see the changes in the flat files.
...
1. **Save** your file.
1. Back in the **relationships.tmdl** file, notice that a new relationship has been added.
...
1. Go back to File explorer and open the PBIT file and see that it looks exactly the same as the PBIP file.
    > It's unlikely that you want an exact copy of your report as your template. Let's fix this.
...
<!-- I'm really conflicted on keeping the added table, but this lab will be really small otherwise. But this message is a bit confusing and I know it'll be confusing.-->
