...
1. The data is loaded as a Spark dataframe. While the Data Wrangler works with either Spark or Pandas dataframes, it is currently optimized to work with Pandas. Therefore, we will convert the data to a Pandas dataframe. Run the following code in your notebook:
