...
> **Note**: See [Getting started with Fabric](https://learn.microsoft.com/fabric/get-started/fabric-trial) for details of how to enable a Fabric trial license. You will need a Microsoft *school* or *work* account to do this.
>
