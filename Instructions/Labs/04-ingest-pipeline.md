...
1. On the **Home** page for your lakehouse, **from your new_data subfolder**, select **Get data** and then select **New data pipeline**, and create a new data pipeline named `Ingest Sales Data`.
