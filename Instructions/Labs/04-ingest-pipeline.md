...
1. On the menu bar on the left, Click on  **+New Item **. In the *New item* page, you can search for keyword lakehouse under the *Data Engineering* section, select **Lakehouse**. Give it a unique name of your choice. Make sure the "Lakehouse schemas (Public Preview)" option is disabled.
