...
lab:
  ...
  description: In Microsoft Fabric, Dataflows (Gen2) connect to various data sources
    ...
    a dataset for a Power BI report.
  duration: 30 minutes
  level: 300
  islab: true
  primarytopics:
...
5. Select **Next** and on the **Choose destination settings** page, disable the **Use automatic settings** option, select **Append** and then **Save settings**.
